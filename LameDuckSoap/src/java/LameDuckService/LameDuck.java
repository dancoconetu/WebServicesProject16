 ...
 * @author justinas
 */
@WebService(serviceName = "LameDuckService", portName = "LameDuckPortTypeBindingPort", endpointInterface = "ws.lameduck.LameDuckPortType", targetNamespace = "http://LameDuck.ws", wsdlLocation = "WEB-INF/wsdl/NewWebServiceFromWSDL/LameDuck.wsdl")
...
return flight;
    ...
    public boolean bookFlight(BookFlightInput input) throws BookFlightFaultMessage, DatatypeConfigurationException {
        ...
        //XMLGregorianCalendar expirityDate;
        
        //    expirityDate = DatatypeFactory.newInstance().newXMLGregorianCalendar(input.getCreditCardDetails().getExpirityDate());
        
        //Create an object of creditCardInfo
        
        CreditCardInfoType CDD = new CreditCardInfoType();
        CDD.setExpirationDate(null);
        CDD.setNumber(input.getCreditCardDetails().getCardNumber());
        //CDD.setExpirationDate(input.getCreditCardDetails().getExpirityDate().getM);
        ExpirationDateType exp = new ExpirationDateType();
        exp.setMonth(input.getCreditCardDetails().getExpirityDate().getMonth());
        exp.setYear(input.getCreditCardDetails().getExpirityDate().getMonth());
        
        //CDD.setExpirationDate(exp);
    ...
    public boolean cancelFlight(CancelFlightInput cancelFlightInput) throws CancelFlightFaultMessage {
        ...
        cancelFlightInput.getCreditCardDetails().getExpirityDate().getMonth();
